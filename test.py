...
HOW = "哮喘是一种慢性气道疾病，通常表现为气道的炎症和痉挛，导致呼吸困难、喘息和咳嗽。\
        如果这是您自己的胸片CT影像，请记得及时去医院就诊，服用相关药物。治疗哮喘的药物可以分为两大类：控制性药物和急性发作时使用的缓解性药物。以下是一些适合您病症的药物清单：\n\
...
response = [
    ...
    f'您好，个人用户{name}，我是小望，很高兴与您进行对话，我将尽我所能为您提供各种医学问答服务，您可以直接向我提问，也可以上传一些医学影像让我进行分析',
        # 上传一张医学影像
    f'检测到您上传了一张{CLASS}，经过初步分析，{RESULT} \n 您可以针对该影像进行更具体的提问，小望将针对您的问题做出更加细致的回答',
        # 提问：我确实患有哮喘病，当前哮喘是否有加重的倾向？
    f'首先，{HOW}。根据当前的信息，小望并不能断定您的哮喘是否有加重的倾向，但是请您依次回答以下问题，以便小望进行分析：\n\
            1.平日里出现呼吸困难、喘息的频率是否有增加？2.夜间是否有因为突然咳嗽而苏醒的状况？',
        # 回答： 1.是   2.无
    f'您最近咳嗽时是否为干咳没有痰，且伴有嗓子干痒、恶心、干呕？',
        # 回答：干咳，偶尔有恶心的感觉，
    f'您是否会感到胸痛，不时伴有晕厥、烦躁不安、心悸、惊恐等感受？',
        # 回答：偶尔胸痛，有烦躁不安
    f'您的哮喘症状可能有加重的趋势，同时结合您上传的影像可能是肺栓塞出现的征兆，这是比较严重的，根据数据库数据查询，您患有或将出现肺栓塞症状的概率高于80%。\
        当然，小望也有可能有犯错的时候，因此为了您的健康，请您务必尽快到附近的医院就诊，\
        您可以提供您的位置信息，由小望综合医疗资源和门诊挂号余量查询最近的诊疗，推荐较好的就诊选择',
        # 浙江省杭州市钱塘新区，二号大街
    f'您好，为您查询到<浙大邵逸夫医院钱塘院区>，已经通过平台预留手机号15958152006关联到您在<浙大邵逸夫医院钱塘院区>的就诊信息，\
        查询到截至当前时间 [2023-08-23 | 21:27]，最近的有余量呼吸内科门诊时间为 【8月29日 周二】下午，余量为【3】个：【15：57 \
            - 22号】余量1个，【16：04 - 23号】余量1个，【16：18 - 25号】余量1个。\
        查询到的医生信息为： 【 周勇 | 主任医师 】，您可以选择合适的时段确认，由小望进行一键预约，或者更换其他时段、医师的门诊',
        # 请预约16：18的门诊 
    f'您将预约的门诊信息为：<浙大邵逸夫医院钱塘院区> ---【16：18 - 25号】余量1个，坐诊医生【 周勇 | 主任医师】\n请确认以上预约信息',
        # 确认
    f'好的，小望已经成功为您预约：<浙大邵逸夫医院钱塘院区> ---【16：18 - 25号】余量1个，坐诊医生【 周勇 | 主任医师】\n稍后您将会收到医院发来的成功预约短信，\
        请及时查收。感谢您使用望问医疗！'
    ]
